...
## Related Concepts
- **[Merkle DAG Lineage](../concepts/design/merkle_dag)**: How the decorator builds the tamper-evident chain across distributed boundaries.
- **[Audit Entry Schema](../concepts/design/audit_entry)**: The technical data structure generated by the decorator at step 6.
- **[Fail-Secure Edges](../concepts/design/edge_cases)**: Handling failures during the 13-step lifecycle.

*For trust model details, see [Trust Model](trust_model). For policy authoring, see [Policy as Code](../concepts/design/abac_policy).*
