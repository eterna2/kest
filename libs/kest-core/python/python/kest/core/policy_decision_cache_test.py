...
from kest.core.decorators import _PolicyDecisionCache, invalidate_policy_cache
from kest.core.engine import MockPolicyEngine
...
def test_invalidate_clears_module_cache():
    ...
    """
    from kest.core.decorators import _POLICY_CACHE
